...
// --- Données ---
const cakes: Cake[] = [
  { id: 1, name: "Licorne Arc-en-ciel", category: "magic", color: "#FFB6C1", stars: 5 },
  { id: 2, name: "Choco Explosion", category: "chocolate", color: "#8B4513", stars: 4 },
  { id: 3, name: "Jardin des Fruits", category: "fruits", color: "#90EE90", stars: 5 },
  { id: 4, name: "Château de Princesse", category: "magic", color: "#DDA0DD", stars: 5 },
  { id: 5, name: "Super Héros", category: "special", color: "#4169E1", stars: 4 },
  { id: 6, name: "Océan Tropical", category: "fruits", color: "#00CED1", stars: 5 }
]
...
const AnnigatoHomepage: React.FC = () => {
  ...
  const handleLike = (cakeId: number) => {
    setLikedCakes(prev => 
      ...
      <main className="px-3 sm:px-4 md:px-6 py-4 sm:py-8 md:py-12">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-12">
          ...
          <p className="text-sm sm:text-base md:text-xl lg:text-2xl text-gray-600 max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-3xl mx-auto px-2">
            Créez, personnalisez et commandez des gâteaux uniques
          </p>
        </div>

        {/* Filtres catégories - mobile et tablette */}
        ...
        <div className="text-center mt-8 sm:mt-10 md:mt-12">
          <button className="group relative bg-gradient-to-r from-yellow-400 via-pink-400 to-purple-400 text-white text-sm sm:text-base md:text-xl lg:text-2xl font-bold py-3 sm:py-4 md:py-5 lg:py-6 px-6 sm:px-8 md:px-10 lg:px-12 rounded-full shadow-2xl hover:scale-105 sm:hover:scale-110 transition-all duration-300">
            <span className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="hidden sm:inline">Créer mon propre gâteau magique !</span>
              <span className="sm:hidden">Créer mon gâteau !</span>
              <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 group-hover:-rotate-180 transition-transform duration-500" />
            </span>
